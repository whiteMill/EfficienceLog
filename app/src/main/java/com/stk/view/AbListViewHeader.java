...
public class AbListViewHeader extends LinearLayout {
	...
	private void initView(Context context) {
		...
		LayoutParams layoutParamsWW = new LayoutParams(LayoutParams.WRAP_CONTENT,
		...
		LayoutParams layoutParamsWW2 = new LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
		...
		LayoutParams layoutParamsWW3 = new LayoutParams(LayoutParams.WRAP_CONTENT,
				LayoutParams.WRAP_CONTENT);
